document.querySelectorAll('.option').forEach(button => {
    button.addEventListener('click', () => {
        ...
        if (isCorrect) {
            console.log("ตอบถูก!");
            if (currentUrl.includes('SolveProblem1Chap.html')) {
...
document.getElementById('next-button').addEventListener('click', () => {
    ...
    if (currentUrl.includes('SolveProblem1Chap.html')) {
        console.log("Navigating to SolveProblem2Chap.html");
        window.location.href = "SolveProblem2Chap.html";
    } else if (currentUrl.includes('SolveProblem2Chap.html')) {
        console.log("Navigating to SolveProblem3Chap.html");
        window.location.href = "SolveProblem3Chap.html";
    } else if (currentUrl.includes('SolveProblem3Chap.html')) {
        console.log("Navigating to Chapter.html");
        window.location.href = "NextSPChapter.html";
    } else {
